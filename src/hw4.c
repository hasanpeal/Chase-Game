...
int make_move(ChessGame *game, ChessMove *move, bool is_client, bool validate_move) {
    ...
    if (validate_move) {
        ...
        if((isupper(game->chessboard[8 - dest_row][dest_col]) != 0 && isupper(game->chessboard[8 - src_row][src_col]) != 0)
        ...
        if(strlen(move->endSquare) == (size_t)3 && ((game->chessboard[8 - src_row][src_col] == 'p' && dest_row == 7) 
            || (game->chessboard[8 - src_row][src_col] == 'P' && dest_row == 0)))
